...
function viewItems() {
	...
	while (listItemEnumerator.moveNext()) {
		...
		if(oListItem.get_item('Marks')!=null)
		listItemInfo +="<td>"+oListItem.get_item('Marks')+"</td>";

		if(oListItem.get_item('Country')!=null)
		listItemInfo +="<td>"+oListItem.get_item('Country').$b_1+"</td>";
...
function createListItem() {
  ...
  // item.set_item('Marks', '99');
	...
	//if Country field is Lookup field
	item.set_item('Country','2');
